...
To enhance the biofilm's resistance to freezing, we have chosen a protein called AnAFP. In comparison to separately introducing the anti-desiccation protein SAHS ([ BBa_K2306003](http://parts.igem.org/Part:BBa_K2306003)) and producing the anti-UV substance MAA, we have discovered a new protein called *H. ex* mtSSB, derived from tardigrades[^4]. It possesses both anti-desiccation and anti-UV capabilities, with significantly lower metabolic stress on *E. coli* compared to TDP and MAA. Therefore, we plan to integrate AnAFP ([BBa_K4765015](http://parts.igem.org/Part:BBa_K4765015)) and *H. ex* mtSSB ([BBa_K4765016](http://parts.igem.org/Part:BBa_K4765016)) into the pRAP system to enable the biofilm to thrive in the harsh Martian environment.
