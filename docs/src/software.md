...
Web UI of RAP has good compatibility and support the following browsers:

<div style="text-align: center;">
    <p>Table 4: browsers support of the Web UI (until Oct 2023).</p>
</div>
...
2. **Run Step 1: KineticHub**
   ...
   ![](https://static.igem.wiki/teams/4765/wiki/czy/kcat-result.png)
...
As shown in workflow, after calculating the optimal enzyme concentration through KineticHub, the corresponding regulatory elements need to be designed through RAP Builder to form the sequence of the pRAP system. We developed a thermodynamic model and Monte Carlo algorithm for the design of the corresponding regulating elements. There are two modes in RAP Builder: RBS design mode and stem loop design mode. We provide a summary of the notation in Table 2.

<div style="text-align: center;">
    <p>Table 2: A summary of the notation for RAP Builder, with the corresponding descriptions.</p>
</div>
...
We provide a summary of the notation in Table 3.

<div style="text-align: center;">
    <p>Table 3: A summary of the notation for PartHub 2, with the corresponding descriptions.</p>
</div>
