...
- [**Safety in Implementation:**](#safety-in-implementation) We determined the potential safety and ethical concerns **from the perspective of biological ethics** and made several attempts to manage the risk.
- [**Safety in Laboratory:**](#safety-in-laboratory) We strictly comply with government regulations and school regulations regarding lab safety. **A duplicate insurance** method is involved to avoid accidents.
- [**Safety in Education:**](#safety-in-education) We took full responsibility for the safety of our audience with specific methods towards the potential risks in our education work.
...
In response to the safety concerns, we attempted to develop a **"Suicide Switch"** that could terminate the engineered bacteria by detecting changes in pressure.
...
With the suggestion of Dr. Jingwei Zhang, we found that **packaging bacteria with hydrogel layers** could not only prevent biological leaks but also facilitate the exchange of energy and vital substances[^1][^2]. This indicates a new risk management strategy. However, there remains a need for further improvement in adapting the hydrogel material to our biofilm.
...
In “Intern Researchers”, we hosted a Lab Experience Day that involved a teaching experiment for high school students(see more details in [Education](/education/#intern-researcher-lab-experience-day)). In terms of safety concerns, all the students who participated had been **well-trained on lab safety issues** by the Shanghai Natural History Museum. To further minimize the risks, we provided them with **a more comprehensive lab safety lecture** and **specific safety guidelines**([Slides](https://static.igem.wiki/teams/4765/wiki/slides/zibodnafingerprint.pdf)). We highlighted that **"everyone operating in a lab should be responsible for the safety of himself/herself, other individuals, and the environment"**.
