const modeOptions = {
  light: {
    '--default-color-10': 'rgba(255, 246, 240, 1)',
    '--default-color-9': 'rgba(255, 246, 240, .9)',
    '--default-color-8': 'rgba(255, 246, 240, .8)',
    '--default-color-7': 'rgba(255, 246, 240, .7)',
    '--default-color-6': 'rgba(255, 246, 240, .6)',
    '--default-color-5': 'rgba(255, 246, 240, .5)',
    '--default-color-4': 'rgba(255, 246, 240, .4)',
    '--default-color-3': 'rgba(255, 246, 240, .3)',
    '--default-color-2': 'rgba(255, 246, 240, .2)',
    '--default-color-1': 'rgba(255, 246, 240, .1)',
