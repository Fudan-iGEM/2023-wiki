    ...
    <div class="home">
      ...
      <section class="page-5">
        ...
        <div style="flex: 1;text-align: center">
            <img src="https://static.igem.wiki/teams/4765/wiki/czy/logo-czy.svg" style="width: 20vw">
        </div>
        <div style="flex: 1">
        <div data-aos="zoom-in-down" data-aos-duration="3000" data-aos-easing="ease-out-cubic" data-aos-anchor-placement="bottom-bottom">
            <p style="margin:0;padding-top:20vh;padding-bottom: 20vh;padding-left:2vw;padding-right:2vw;color:#242424;font-size: 1.5vw;flex: 1">The B.HOME project revolves around four interdependent systems: Survival, Symbiotic, Biofilm Formation, and Terraforming Systems. Through these systems, we have constructed an ecological biofilm with extreme tolerance, autotrophic survival, physical structure, and rock weathering function.</p>
        </div>
        </div>
      </section>
