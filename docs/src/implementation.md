...
Considering that our transformation target is the desolate Martian rocks, Fudan iGEM 2023 intends to use cyanobacteria and *E. coli* as the chassis to construct a living biofilm and apply them to the rock surface.

1. **Spray our Living Biofilm**

   With the Biofilm Formation System(more details in [Description](https://2023.igem.wiki/fudan/description/)), the cyanobacteria and engineering *E. coli form a living biofilm. **Evenly sprayed on the Martian surface**, the biofilm will quickly spread and cover the bare rocks with the bacteria proliferating. Cyanobacteria will take full advantage of atmospheric CO~2~ to produce enough energy and organic substances by photosynthesis. Thus, without any extra support, the biofilm could consistently grow on Mars.

2. **Provide a Water Source**

   For the severe drought on the Martian surface, a water source is necessary for the successful initial settlement of our biofilm. To provide a water source, you should collect the abundant ice on Mars, melt it into water by heaters, and spray the water onto our biofilm.
...
4. **Survival System for Long-term Growth**
   ...
   A survival system(more details in [Description](https://2023.igem.wiki/fudan/description/)) was introduced into our biofilm to equip it with resistance to the harsh environment of Mars. With normal expression of the survival system. our biofilm could maintain a normal survival time of about 7 days.



## Safety Concerns

For the well-being of all mankind, we have obtained a deep insight into the safety concerns of our product from the perspective of environmental ethics and bioethics(more details in [Human Practice](https://2023.igem.wiki/fudan/human-practices/#managing-the-risk)). Aware of our responsibility to manage the risk, we have made multiple attempts to ensure the safety in the future application of our product(more details in [Safety](https://2023.igem.wiki/fudan/safety/)).
...
1. **Environment: Addressing Soil Problems**
   ...
   The production of oxalic acid by engineered bacteria has potential applications in the transformation of soil. Salinization is known as the "stubborn disease" of the land, and the soil salt content is so high that crops are low-yielding or cannot grow. Oxalic acid is a good medicine to **address soil salinity**, and the production of oxalic acid by engineered bacteria can realize the mass production of oxalic acid, and achieve the goal of oxalic acid to improve saline soil.

2. **Agriculture: Improve crop cultivation**

   Engineering bacteria to produce EPS is effective in order to **improve soil fertility**. Extracellular polysaccharide is the binder to form soil aggregate structure and keep the aggregate stable. The use of microbial EPS to improve the soil can make the soil more loosened and permeable and reduce soil crusting, which will be beneficial to crop production.

   Antifreeze proteins produced by engineered bacteria can be used to **improve crop viability**. Low temperatures may cause crops to suffer from frost and thus reduce yields. Biological antifreeze may provide new ideas in the field of crop improvement.

   Anti-desiccation proteins, when used in combination with crops, can enhance water retention and greatly **improve recovery from drought and water scarcity**. It has potential improvement functions in the field of crop cultivation in arid areas.

3. **Cosmetic: Sunscreen Products**

   MAAs have potential applications in the field of **biological sunscreen**. Batch production of traditional chemical sunscreens causes pollution of chemical waste. UV-resistant substances MAAs extracted from biological sources could open the way for the production of environmentally conscious UV-absorbing coatings.

4. **Synthetic Biology: Regulate Polynucleotide Co-expression System**

   Our self-cleaving ribozyme helps to manage any **polynucleotide co-expression system**, which is common in anabolic pathways. The auto-cleaving ribozyme system can be used in synthetic biology co-expression systems and can precisely regulate protein expression levels with minimal carrier DNA. 
